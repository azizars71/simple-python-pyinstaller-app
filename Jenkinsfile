                    ...
                    try {
                        ...
                        sshagent(credentials: [SSH_CREDENTIALS]) {
                            sh """
                                ...
                                ssh ${EC2_USER}@${EC2_HOST} "sudo logger 'add2vals berhasil di-copy dari Jenkins!' | sudo tee -a /var/log/deploy.log"
                                ssh ${EC2_USER}@${EC2_HOST} "sudo cat /var/log/deploy.log | logger"
                            """
                        }
